...
public class UserController {
    ...
    @Operation(summary = "프로필 사진 수정", description = "내 프로필 사진을 수정합니다.")
    @PatchMapping(value = "/updateProfileImage", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ApiResponse<String> updateProfileImage(
            @RequestPart("profileImage") MultipartFile profileImage
    ) {
        String imagePath = userService.updateProfileImage(profileImage);
